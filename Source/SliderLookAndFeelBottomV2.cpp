...
SliderLookAndFeelBottomV2::SliderLookAndFeelBottomV2(){
...
void SliderLookAndFeelBottomV2::drawRotarySlider(Graphics &g,
                                                 int x,
                                                 int y,
                                                 int w,
                                                 int h,
                                                 ...
                                                 Slider &s)
{
    ...
    filledArc.addPieSegment(EllipseX, EllipseY, widthEllipse, widthEllipse, 6.2332, angle, 0);
